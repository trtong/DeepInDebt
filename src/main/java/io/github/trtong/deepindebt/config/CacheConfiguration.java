package io.github.trtong.deepindebt.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("DeepInDebt");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("DeepInDebt");
        ...
        config.getMapConfigs().put("io.github.trtong.deepindebt.domain.*", initializeDomainMapConfig(jHipsterProperties));
